...
- [x] **WebSocket data displayed** - So you can see which of your buddies are in the library. When you click the "in library" button you'll pop up to everyone else.
